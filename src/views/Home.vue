...
<template>
  ...
  <Navbar 
    ...
    @products-filter="handleProductsFilter"
  />
  <Hero />
  <TodayBestDeals 
...
const { products, pagination, isLoading, fetchProducts } = useProductsApi();
...
const isFiltering = computed(() => {
  return !!(searchQuery.value || categoryFilter.value || 
    currentFilters.value.minPrice || currentFilters.value.maxPrice);
});
