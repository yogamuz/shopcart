<!-- AdminDashboard.vue - Main Component with Separated Components -->
<template>
  ...
  <div class="min-h-screen bg-[#FAFBFD] font-inter">
    ...
    >
      ...
      <main class="p-3 sm:p-4 lg:p-6">
        ...
        <!-- Profile Management -->
        <AdminUsers v-if="activeNav === 'Users'" @navigate-to="handleNavClick" />

        <AdminCache v-else-if="activeNav === 'Cache'" />
        <!-- Wallet Management -->
        <AdminWallet v-else-if="activeNav === 'Wallet'" />
...
const getPageTitle = () => {
  ...
  return titles[activeNav.value] || "Dashboard"; // ✅ TAMBAHKAN return statement
};
